...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col-reverse lg:flex-col justify-center items-center gap-2 px-6 relative overflow-hidden mt-28 md:mt-28 lg:mt-25"
    >
      ...
      <div className="hidden lg:block hero-badge hero-badge-left text-center">
        ...
        <p>
          Self-taught developer focused on learning and turning your ideas into
      ...
      <div className="relative flex items-center justify-center mb-14 mt-14">
        ...
        <div className="relative z-10 rounded-full p-[6px] bg-[var(--bg-secondary)]">
          <img
            src={heroImage}
